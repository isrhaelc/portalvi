 ...
 */
package com.prudential.portalvi.core.models;
...
import com.prudential.portalvi.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "portalvi/components/helloworld");
